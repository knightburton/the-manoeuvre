...
<tileset name="spinner-animation-tileset" tilewidth="256" tileheight="256" tilecount="48" columns="24">
 <image source="../img/tileset/spinner-animation-tileset.png" width="6144" height="512"/>
 <tile id="0">
		<animation>
